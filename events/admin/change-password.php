...
if (!$userResult || mysqli_num_rows($userResult) !== 1) {
    exit('Could not load current user.');
}
...
<head>
    <meta charset="utf-8">
    <title>Change Password | Event Forge Admin</title>
...
<div class="wrap">
    ...
    <p>Signed in as <strong><?= htmlspecialchars((string) $user['username']) ?></strong></p>
    ...
    <div class="card">
        ...
        <form method="post" action="<?= htmlspecialchars(eventforge_admin_path('save-password.php')) ?>">
